...
void draw_sudoku_play() {
	...
	attron(COLOR_PAIR(5));
	mvprintw(start_row + 20, start_col - 5,
	         "Arrow Keys: Move | 1-9: Enter Number");
	mvprintw(start_row + 21, start_col - 5,
	         "0/Delete: Clear | C: Check Solution");
	mvprintw(start_row + 22, start_col - 5,
	         "H: Hint | S: Show Solution | Q: Quit");
